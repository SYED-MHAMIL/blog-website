      ...
      {data.length > 0 && (
        <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white py-8 px-4 text-center">
          ...
          <p className="text-lg sm:text-xl font-medium max-w-2xl mx-auto">
            Discover insightful articles, tutorials, and stories to inspire your
            journey.
          </p>
        </div>
      )}
...
const CategoryCard = async ({ id }: { id: number }) => {
  ...
  return (
    <div className="flex items-center gap-1 bg-slate-50 px-2 rounded-full bg-opacity-50 py-1">
      <Image
        src={catData?.iconURL}
        height={50}
        width={50}
