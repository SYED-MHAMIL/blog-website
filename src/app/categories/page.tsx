...
<>
                ...
                {       categories.length > 0 &&       <div className='text-center mt-8'>
                           <h1 className="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-3xl lg:text-5xl">Select <mark className="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">Category</mark> </h1>
...
<div className='flex gap-12 flex-wrap justify-center mt-32 mx-12 items-center'>
    {
        categories.length > 0 ?  categories.map(v=>{
              return <Link href={`categories/${v.id}`}>
