import { individualCategory, ReadCategory } from "@/firebase/category/read-server";
...
export default async function SelectedCategory({params} :{params : {categoriesId :number} }){
